...
{env, ...}: {
  ...
  mySystem.systemd-services.swaybg.enable = true;
  mySystem.systemd-services.wayle.enable = true;
  mySystem.systemd-services.cliphist.enable = true;
  ...
  mySystem.apps.plain-app.enable = true;
