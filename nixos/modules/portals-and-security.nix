{pkgs, ...}: {
  ...
  environment.systemPackages = with pkgs; [
    # polkit_gnome # Graphical password prompt dialog for polkit
    # seahorse # Keyring / secret storage password manager GUI
    xdg-utils # Command-line desktop integration tools
  ];
}
