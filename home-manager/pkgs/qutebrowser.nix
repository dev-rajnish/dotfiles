# =============================================================================
#  Declarative Qutebrowser Packaging & Configuration
#  Modal, Vim-driven browser with Dark Reader mode, Bitwarden, Raindrop,
#  DuckDuckGo search default, Ask-where-to-save & Compact UI
# =============================================================================
{
  pkgs,
  lib,
